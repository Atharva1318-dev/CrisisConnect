...
const incidentSchema = new mongoose.Schema(
  {
    ...
    forensics: {
      ...
      analysis: {
        ...
        aiDetected: mongoose.Schema.Types.Mixed,
        pixelAnalysis: mongoose.Schema.Types.Mixed,
        noiseAnalysis: mongoose.Schema.Types.Mixed,
...
incidentSchema.index({ whatsappPhone: 1 });
incidentSchema.index({ telegramChatId: 1 });
