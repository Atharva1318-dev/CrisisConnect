...
const NewsSummarizer = () => {
  ...
  return (
    <div className="min-h-screen bg-white py-8 px-4 pt-[120px]">
      <div className="max-w-5xl mx-auto">
        {/* Header */}
        ...
        {/* Main Card */}
        <main className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 md:p-8 mb-6">
          <form onSubmit={submit} className="space-y-6" aria-describedby="form-help">
            {/* Location Section */}
            <section className="border border-gray-200 rounded-xl p-6">
              <div className="flex items-center justify-between mb-6 flex-col md:flex-row gap-4">
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    onClick={getLocation}
                    disabled={locationLoading}
                    className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition flex items-center gap-2 text-sm disabled:opacity-50 font-medium"
                    aria-label="Use my current location"
                  >
                    {locationLoading ? (
                      <>
                  ...
                  <button
                    type="button"
                    onClick={clearForm}
                    className="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-900 rounded-lg transition text-sm font-medium"
                  >
                    Clear
                  </button>
                </div>
              ...
              <div className="flex gap-2 flex-wrap">
                <button
                  type="button"
                  onClick={() => setSampleLocation(19.033, 73.0297)}
                  className="px-3 py-2 bg-gray-100 hover:bg-gray-200 text-gray-900 rounded-lg text-sm font-medium transition"
                >
                  Navi Mumbai
                </button>
                <button
              ...
              {error && (
                <div
                  className="mt-4 bg-red-50 border border-red-200 rounded-lg p-3 flex items-start gap-3"
                  role="alert"
                  aria-live="assertive"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select
                  id="query"
                  className="w-full bg-white border border-gray-300 rounded-lg px-4 py-3 text-gray-900 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition font-medium"
                  value={query}
                  onChange={(e) => setQuery(e.target.value)}
                >
                  <option value="floods">Floods</option>
            ...
            <div className="flex gap-3 pt-4">
              <button
                type="submit"
                disabled={loading || !lat || !lon}
                className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-3 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition flex items-center justify-center gap-2"
                aria-disabled={loading || !lat || !lon}
              >
                {loading ? (
                  <>
              ...
              <button
                ...
                className="px-6 py-3 bg-gray-100 hover:bg-gray-200 text-gray-900 rounded-lg transition font-medium"
              >
                Reset
              </button>
            </div>
        ...
        <section aria-live="polite" className="space-y-6 animate-fadeIn">
          {result ? (
            <>
              ...
              <div className="border border-gray-200 rounded-xl p-6 bg-gray-50">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  <div className="flex items-center gap-3">
                    {result.isLiveEvent ? (
                      <div className="flex items-center gap-2 bg-red-100 text-red-700 px-3 py-1 rounded-full">
                        ...
                        <span className="font-semibold text-sm">LIVE EVENT</span>
                      </div>
                    ) : (
                      <div className="flex items-center gap-2 bg-blue-100 text-blue-700 px-3 py-1 rounded-full">
                        <Clock className="w-4 h-4" />
                        <span className="font-semibold text-sm">HISTORICAL</span>
                      </div>
                    )}
                  </div>
                  <div>
                  ...
                  <div className="md:text-right">
                    <p className="text-gray-600 text-sm">Records Found</p>
                    <p className="text-gray-900 font-semibold">
                      {result.resultCount ?? result.sources?.length ?? 0} results
                    </p>
                    {lastSearchAt && (
                      <p className="text-gray-500 text-xs mt-1">
                        {new Date(lastSearchAt).toLocaleString()}
                      </p>
                    )}
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {result.sources.map((s, i) => (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="group p-4 bg-white border border-gray-200 rounded-lg hover:border-blue-400 hover:shadow-md transition"
                      >
                        <div className="flex items-start gap-3">
                          <div className="w-2 h-2 bg-blue-600 rounded-full mt-1.5 flex-shrink-0"></div>
                          <div className="flex-1 min-w-0">
                            <p className="text-blue-600 group-hover:text-blue-700 font-semibold line-clamp-2 transition">
                              {s.title || "View Record"}
                            </p>
                            <div className="text-gray-500 text-xs mt-2 space-y-1">
                              {s.url && s.url !== "#" && (
                          ...
                          <svg
                            className="w-4 h-4 text-gray-400 group-hover:text-blue-600 transition flex-shrink-0"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
            ...
            <div className="text-center text-gray-500 py-12 border border-gray-200 rounded-xl bg-gray-50">
              <Clock className="mx-auto mb-3 w-8 h-8 text-gray-400" />
              <p>No results yet — run a search to see summaries and sources.</p>
            </div>
          )}
